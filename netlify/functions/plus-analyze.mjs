...
export const handler=wrap(async event=>{
  ...
  if(!eligibleProfile(account.profile))fail(403,'Seu CRM ainda precisa ser verificado para liberar a análise.');
